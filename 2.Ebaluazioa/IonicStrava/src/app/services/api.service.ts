...
export class ApiService {
  ...
  async addJarduera(jarduera: Jarduera){
    let data = [jarduera.atleta_id, jarduera.name, jarduera.type, jarduera.moving_time, jarduera.elapsed_time];
    const res = await this.storage.executeSql('INSERT INTO jardueras (atleta_id, name, type,moving_time,elapsed_time) VALUES (?, ?, ?, ?, ?)', data);
